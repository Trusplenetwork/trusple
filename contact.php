<?php
	...
	if (isset($_POST['email'])) {
		...
		$email_to = "windwinger@gmail.com";
		$email_subject = "My offer for [trusple.network]";
									...
									<div class="vMiddle">
										...
										<div class="row d-md-flex text-center justify-content-center text-primary action-icons">
											<div class="col-sm-4">
												...
												<p class="lead"><a href="https://t.me/trusplenetwork">@trusplenetwork</a></p>
											</div>
											<div class="col-sm-4">
												<p><em class="ion-ios-chatbubble-outline icon-md"></em></p>
												<p class="lead"><a href="mailto:windwinger@gmail.com">windwinger@gmail.com</a></p>
											</div>
									</div>
								</div>
							</div>
									...
									<section class="bg-alt">
											<div class="row height-100">
													<div class="col-sm-8 offset-sm-2 mt-2">
														...
														<br/>
														<a target="_blank" rel="nofollow" href="https://trusple.network">trusple.network</a>
													</div>
											</div>
									</section>
							</div>
